...
public class MicrobiologyAutomatonManager : MonoBehaviour
{
    ...
    IEnumerator AnalyzeCorroutine()
    {
        ...
        {
            Slot.transform.position = Vector3.Lerp(originalPosition, SlotTarget.transform.position, (elapsedTime / time));
