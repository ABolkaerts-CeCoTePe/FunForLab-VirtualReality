...
{
    public void SetLanguage(int langue)
    {
    ...
    {
        SetLanguage(Localization.GetLanguage(SystemLanguage.English), 0);
    }
    public void SetFrenchLanguage()
    {
        SetLanguage(Localization.GetLanguage(SystemLanguage.French), 1);
    }
    public void SetDutchLanguage()
    {
        SetLanguage(Localization.GetLanguage(SystemLanguage.Dutch), 2);
    }
    public void SetGermanLanguage()
    {
        SetLanguage(Localization.GetLanguage(SystemLanguage.German), 4);
    }

    public void SetLanguage(string lang, int language)
    {
